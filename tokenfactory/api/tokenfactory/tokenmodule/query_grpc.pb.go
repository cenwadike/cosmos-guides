...
const (
	Query_Params_FullMethodName   = "/tokenfactory.tokenmodule.Query/Params"
	Query_Denom_FullMethodName    = "/tokenfactory.tokenmodule.Query/Denom"
	Query_DenomAll_FullMethodName = "/tokenfactory.tokenmodule.Query/DenomAll"
)

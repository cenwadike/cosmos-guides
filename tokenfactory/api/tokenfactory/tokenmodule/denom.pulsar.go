...
func init() {
	...
	md_Denom = File_tokenfactory_tokenmodule_denom_proto.Messages().ByName("Denom")
...
func (x *Denom) slowProtoReflect() protoreflect.Message {
	mi := &file_tokenfactory_tokenmodule_denom_proto_msgTypes[0]
...
func (x *fastReflection_Denom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tokenfactory.tokenmodule.Denom.denom":
		return x.Denom != ""
	case "tokenfactory.tokenmodule.Denom.description":
		return x.Description != ""
	case "tokenfactory.tokenmodule.Denom.ticker":
		return x.Ticker != ""
	case "tokenfactory.tokenmodule.Denom.precision":
		return x.Precision != int32(0)
	case "tokenfactory.tokenmodule.Denom.url":
		return x.Url != ""
	case "tokenfactory.tokenmodule.Denom.maxSupply":
		return x.MaxSupply != int32(0)
	case "tokenfactory.tokenmodule.Denom.supply":
		return x.Supply != int32(0)
	case "tokenfactory.tokenmodule.Denom.canChangeMaxSupply":
		return x.CanChangeMaxSupply != false
	case "tokenfactory.tokenmodule.Denom.owner":
		return x.Owner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tokenfactory.tokenmodule.Denom"))
		}
		panic(fmt.Errorf("message tokenfactory.tokenmodule.Denom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Denom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tokenfactory.tokenmodule.Denom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Denom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "tokenfactory.tokenmodule.Denom.denom":
		panic(fmt.Errorf("field denom of message tokenfactory.tokenmodule.Denom is not mutable"))
	case "tokenfactory.tokenmodule.Denom.description":
		panic(fmt.Errorf("field description of message tokenfactory.tokenmodule.Denom is not mutable"))
	case "tokenfactory.tokenmodule.Denom.ticker":
		panic(fmt.Errorf("field ticker of message tokenfactory.tokenmodule.Denom is not mutable"))
	case "tokenfactory.tokenmodule.Denom.precision":
		panic(fmt.Errorf("field precision of message tokenfactory.tokenmodule.Denom is not mutable"))
	case "tokenfactory.tokenmodule.Denom.url":
		panic(fmt.Errorf("field url of message tokenfactory.tokenmodule.Denom is not mutable"))
	case "tokenfactory.tokenmodule.Denom.maxSupply":
		panic(fmt.Errorf("field maxSupply of message tokenfactory.tokenmodule.Denom is not mutable"))
	case "tokenfactory.tokenmodule.Denom.supply":
		panic(fmt.Errorf("field supply of message tokenfactory.tokenmodule.Denom is not mutable"))
	case "tokenfactory.tokenmodule.Denom.canChangeMaxSupply":
		panic(fmt.Errorf("field canChangeMaxSupply of message tokenfactory.tokenmodule.Denom is not mutable"))
	case "tokenfactory.tokenmodule.Denom.owner":
		panic(fmt.Errorf("field owner of message tokenfactory.tokenmodule.Denom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tokenfactory.tokenmodule.Denom"))
		}
...
func (x *fastReflection_Denom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tokenfactory.tokenmodule.Denom", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: tokenfactory/tokenmodule/denom.proto
...
func (*Denom) Descriptor() ([]byte, []int) {
	return file_tokenfactory_tokenmodule_denom_proto_rawDescGZIP(), []int{0}
}
...
var File_tokenfactory_tokenmodule_denom_proto protoreflect.FileDescriptor

var file_tokenfactory_tokenmodule_denom_proto_rawDesc = []byte{
	0x0a, 0x24, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x2f, 0x64, 0x65, 0x6e, 0x6f, 0x6d,
	...
	0x22, 0x83, 0x02, 0x0a, 0x05, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x12, 0x14, 0x0a, 0x05, 0x64, 0x65,
	...
	,
	...
	0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x42, 0xd6, 0x01, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2e, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x42, 0x0a, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x50, 0x72,
	0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x29, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63, 0x74,
	...
	,
}

var (
	file_tokenfactory_tokenmodule_denom_proto_rawDescOnce sync.Once
	file_tokenfactory_tokenmodule_denom_proto_rawDescData = file_tokenfactory_tokenmodule_denom_proto_rawDesc
)

func file_tokenfactory_tokenmodule_denom_proto_rawDescGZIP() []byte {
	file_tokenfactory_tokenmodule_denom_proto_rawDescOnce.Do(func() {
		file_tokenfactory_tokenmodule_denom_proto_rawDescData = protoimpl.X.CompressGZIP(file_tokenfactory_tokenmodule_denom_proto_rawDescData)
	})
	return file_tokenfactory_tokenmodule_denom_proto_rawDescData
}

var file_tokenfactory_tokenmodule_denom_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_tokenfactory_tokenmodule_denom_proto_goTypes = []interface{}{
	(*Denom)(nil), // 0: tokenfactory.tokenmodule.Denom
}
var file_tokenfactory_tokenmodule_denom_proto_depIdxs = []int32{
...
func init() { file_tokenfactory_tokenmodule_denom_proto_init() }
func file_tokenfactory_tokenmodule_denom_proto_init() {
	if File_tokenfactory_tokenmodule_denom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_tokenfactory_tokenmodule_denom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Denom); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_tokenfactory_tokenmodule_denom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_tokenfactory_tokenmodule_denom_proto_goTypes,
		DependencyIndexes: file_tokenfactory_tokenmodule_denom_proto_depIdxs,
		MessageInfos:      file_tokenfactory_tokenmodule_denom_proto_msgTypes,
	}.Build()
	File_tokenfactory_tokenmodule_denom_proto = out.File
	file_tokenfactory_tokenmodule_denom_proto_rawDesc = nil
	file_tokenfactory_tokenmodule_denom_proto_goTypes = nil
	file_tokenfactory_tokenmodule_denom_proto_depIdxs = nil
}
